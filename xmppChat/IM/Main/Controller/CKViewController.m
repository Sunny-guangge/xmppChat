...
- (void)viewDidLoad {
    ...
    UITabBarItem *discoverTabbarItem = [self.tabBar.items objectAtIndex:2];
    UITabBarItem *personalTabbarItem = [self.tabBar.items objectAtIndex:3];
    ...
    UIImage *normalImage3 = [[UIImage imageNamed:@"tabbar_discover"] imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal];
    UIImage *selectImage3 = [[UIImage imageNamed:@"tabbar_discoverHL"] imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal];
    discoverTabbarItem.image = normalImage3;
    discoverTabbarItem.selectedImage = selectImage3;
    
    UIImage * normalImage4 = [[UIImage imageNamed:@"tabbar_me"]  imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal];
    UIImage * selectImage4 = [[UIImage imageNamed:@"tabbar_meHL"]  imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal];
    personalTabbarItem.image = normalImage4;
    personalTabbarItem.selectedImage = selectImage4;
